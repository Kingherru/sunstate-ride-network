// My Florida NEMT blog content — pillar articles seeded for the blog engine.
...
export const POSTS: Post[] = [
  {
    ...
    readMinutes: 8,
    author: "My Florida NEMT Editorial Team",
    cover: "cobalt",
    keywords: [
    ...
    body: [
      ...
      { t: "p", c: "A professional My Florida NEMT provider will call or text before pickup, arrive in a marked vehicle with a visibly ID-badged driver, help you into the seat or secure your wheelchair, and give you a written pickup time for the return trip. The driver should be quiet, courteous, and never leave you unattended at a hospital entrance. If any of that is missing — late arrivals, no-shows, unsafe driving, unprofessional behavior — you have the right to switch providers." },
      ...
      { t: "cta", heading: "Need a ride now?", body: "Request a verified My Florida NEMT provider in your county. We match you with the right vehicle type — ambulatory, wheelchair, or stretcher — and confirm within minutes.", to: "/request-a-ride", label: "Request a Ride" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    title: "How to Join the My Florida NEMT Provider Network: A Complete 2026 Guide",
    metaTitle: "Join a My Florida NEMT Network: Credentials, Contracts, Rates (2026)",
    metaDescription:
      "Everything a My Florida NEMT operator needs to join a provider network in 2026 — AHCA registration, insurance minimums, vehicle standards, credentialing, and how trips are dispatched.",
    excerpt:
    ...
    body: [
      ...
      { t: "cta", heading: "Ready to join a My Florida NEMT network?", body: "Skip the broker-by-broker paperwork. Apply once through My Florida NEMT and get access to trips across every major managed-care plan.", to: "/join-our-network", label: "Apply to Join" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    body: [
      ...
      { t: "cta", heading: "Book your Medicaid ride the easy way", body: "My Florida NEMT works with providers contracted to every major Medicaid managed-care plan. Request a ride and we'll route your trip to the right dispatcher.", to: "/request-a-ride", label: "Request a Ride" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    body: [
      ...
      { t: "p", c: "Most My Florida NEMT providers allow one attendant to ride at no additional cost, especially for pediatric patients, dementia patients, and post-op discharges. Say so when you book. Bring the insurance card, a printed medication list, and a phone charger. Introduce yourself to the driver so they know who to look for on the return." },
      ...
      { t: "cta", heading: "Book one ride or a whole month at once", body: "My Florida NEMT lets caregivers save patient profiles and schedule recurring trips in one place. Request a ride and set up standing orders in the same flow.", to: "/request-a-ride", label: "Book a Ride" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    title: "My Florida NEMT in 2026: Market Growth, Managed-Care Contracts, and What's Next",
    metaTitle: "My Florida NEMT 2026 Trends: Market Growth & Managed-Care Contracts",
    metaDescription:
    ...
    body: [
      ...
      { t: "cta", heading: "Compete for premium contracts", body: "My Florida NEMT gives contracted operators a live dispatch board, EDI-ready billing, and per-trip performance reporting the plans actually accept.", to: "/join-our-network", label: "Join the Network" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    metaDescription:
      "The core training every My Florida NEMT driver needs: HIPAA privacy, passenger assistance, ADA-compliant wheelchair securement, defensive driving, and first-aid.",
    excerpt:
      "The five training modules every professional My Florida NEMT driver must complete before their first solo dispatch — with a straight-talk checklist for owners building an in-house program.",
    ...
    body: [
      ...
      { t: "cta", heading: "Train drivers to the standard the plans measure", body: "My Florida NEMT publishes the training curriculum, quizzes, and audit-ready credential tracker we use across our provider network.", to: "/training", label: "See the Training Modules" },
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    body: [
      ...
      { t: "cta", heading: "Build a reliable Florida discharge network", body: "My Florida NEMT contracts hospitals and SNFs statewide with a single point of dispatch, live tracking, and monthly performance reporting.", to: "/contact", label: "Talk to Our Team" },
    ],
  },
  ...
  // ---------- Patient Resources ----------
  {
    ...
    body: [
      ...
      { t: "cta", heading: "Book a wheelchair-accessible ride in Florida", body: "My Florida NEMT dispatches lift-equipped vans statewide with trained wheelchair-transport drivers and four-point securement on every trip.", to: "/request-a-ride", label: "Request a Ride" },
    ],
  },
  {
    ...
    body: [
      ...
      { t: "cta", heading: "Set up a reliable dialysis schedule", body: "My Florida NEMT runs standing dialysis orders statewide with same-driver preference, dispatch coverage through the last treatment of the day, and Medicaid & Medicare Advantage billing.", to: "/request-a-ride", label: "Request Recurring Rides" },
    ],
  },
  {
    slug: "patient-rights-nemt-florida",
    category: "Patient Resources",
    title: "Your Rights as a My Florida NEMT Patient",
    metaTitle: "My Florida NEMT Patient Rights: Complaints, Denials, Appeals",
    metaDescription:
      "What every My Florida NEMT patient is entitled to — timely pickup, a safe vehicle, HIPAA privacy — and how to file a complaint or appeal a denial.",
    excerpt:
      "Denied a ride? Waited two hours in a lobby? My Florida NEMT patients have specific, enforceable rights. Here's what they are and how to use them.",
    ...
    body: [
      { t: "p", c: "My Florida NEMT is regulated by the Agency for Health Care Administration (AHCA), the Commission for the Transportation Disadvantaged (CTD), and each Medicaid managed-care plan's contract. Together they create a floor of patient rights that no provider or broker can override." },
      ...
      { t: "p", c: "Every My Florida NEMT patient is entitled to a caregiver or attendant seat at no extra cost when the caregiver's presence is medically necessary — for cognitive impairment, language interpretation, or physical assistance. Note the caregiver at booking; some providers require 24-hour notice." },
  ...
  // ---------- Provider Resources ----------
  {
    ...
    excerpt:
      "The My Florida NEMT market is growing fast, but the licensing path is not obvious. Here is the checklist we wish every new provider had before they bought their first van.",
  ...
  },
  {
    ...
    metaDescription:
      "How My Florida NEMT providers bill Medicaid managed-care plans — trip records, HCPCS codes A0080–A0130, per-mile rates, and the top denial reasons to avoid.",
    excerpt:
    ...
    author: "My Florida NEMT Editorial Team",
    cover: "cobalt",
    keywords: ["My Florida NEMT billing", "medicaid transportation codes", "A0130 A0100 HCPCS", "NEMT denial reasons"],
    ...
    body: [
      ...
      { t: "p", c: "Reconcile every submitted trip against the broker's remittance within 14 days. Set up denial buckets by reason code and rework them weekly — the vast majority of My Florida NEMT denials are curable with a signature capture, GPS proof, or a corrected authorization number." },
      { t: "cta", heading: "Bill Medicaid faster with our dispatch stack", body: "The My Florida NEMT platform captures signatures, GPS, and trip records automatically — export ready for every major broker.", to: "/join-our-network", label: "See the Platform" },
    ],
  },
  {
    ...
    metaTitle: "My Florida NEMT Insurance: Auto, GL, WC, Umbrella — 2026 Minimums",
    metaDescription:
      "2026 insurance minimums for My Florida NEMT providers — commercial auto, general liability, workers comp, umbrella, and how brokers verify.",
    excerpt:
  ...
  // ---------- Caregiver Guides ----------
  {
    ...
    metaTitle: "Caregiver Medical Appointment Checklist — My Florida NEMT",
    metaDescription:
    ...
    body: [
      ...
      { t: "cta", heading: "Book a caregiver-friendly ride", body: "My Florida NEMT welcomes caregivers on every trip and dispatches drivers trained to work with families.", to: "/request-a-ride", label: "Request a Ride" },
    ],
  },
  {
    ...
    body: [
      ...
      { t: "cta", heading: "Get help setting up a routine", body: "My Florida NEMT works with families to build multi-program transportation plans for aging parents.", to: "/contact", label: "Talk to a Care Coordinator" },
    ],
  },
  ...
  // ---------- Industry News ----------
  {
    ...
    excerpt:
      "The NEMT software market is loud with 'AI dispatching' claims. Here's the feature list that actually keeps a My Florida NEMT operation running.",
    ...
    body: [
      ...
      { t: "cta", heading: "See our dispatch stack", body: "My Florida NEMT operators use our platform with EDI to the major brokers, driver app, and automated credential tracking.", to: "/join-our-network", label: "Book a Demo" },
    ],
  },
  ...
  // ---------- Florida Transportation Resources ----------
  {
    ...
    metaDescription:
      "County-by-county overview of My Florida NEMT coverage — Community Transportation Coordinators, service quirks, and what patients should know before booking.",
    excerpt:
      "My Florida NEMT looks different in every county because every county has its own Community Transportation Coordinator. Here's the overview patients and families need.",
    publishedAt: "2026-07-08",
    readMinutes: 8,
    author: "My Florida NEMT Editorial Team",
    cover: "sand",
    keywords: ["My Florida NEMT counties", "CTC Florida", "county transportation Florida", "Florida transportation disadvantaged"],
    ...
    body: [
      ...
      { t: "p", c: "Hurricanes, snowbird season, and I-4 / I-95 congestion patterns affect every My Florida NEMT operation. During a declared emergency, non-urgent NEMT is often suspended 24-48 hours before landfall. Dialysis, oxygen, and hospital discharge trips continue with priority. Sign up for county emergency alerts before hurricane season starts." },
      { t: "cta", heading: "Book NEMT in any Florida county", body: "My Florida NEMT dispatches statewide — from the Panhandle to the Keys — with one phone number and one dispatch team.", to: "/request-a-ride", label: "Request a Ride" },
    ],
  },
];
