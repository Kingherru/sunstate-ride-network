...
export function downloadCms1500(input: Cms1500Input) {
  ...
  doc.text("Generated by MyFloridaNemt.com — CMS-1500 (02/12) format for medical transportation billing. Verify all data before submission.", pageW / 2, 760, { align: "center" });
