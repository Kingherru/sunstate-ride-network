  ...
  return (
    <div className="bg-white" style={{ color: NAVY }}>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4">
        {[
          { icon: <MapPin size={20} />, value: "67", label: "Counties", bg: NAVY, fg: "#fff" },
          { icon: <Clock size={20} />, value: "24/7", label: "Dispatch", bg: PEACH, fg: NAVY },
          { icon: <Shield size={20} />, value: "100%", label: "HIPAA Compliant", bg: MINT, fg: NAVY },
          { icon: <Phone size={20} />, value: "3,500+", label: "Daily Trips", bg: CORAL, fg: "#fff" },
        ].map((s) => (
